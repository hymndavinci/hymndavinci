...
| --- | --- | --- |
| **Portfolio** | Personal portfolio with projects, blog, Discord presence, auth comments, and rating system. | Next.js, TypeScript, Tailwind, Prisma |
| **Hymn+** | Personal Discord workflow dashboard with account status, music system, AI chat, screenshot utility, and worker tools. | Node.js, Express, EJS, Lavalink |
| **BintangMovies** | Streaming-style movie interface powered by movie metadata and modern UI patterns. | React, TypeScript, Tailwind |
| **KasirPintar AI** | Finance management app for UMKM with AI-powered transaction analysis. | Next.js, TypeScript, Gemini AI |
